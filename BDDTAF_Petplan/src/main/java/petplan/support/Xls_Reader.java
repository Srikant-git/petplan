...
/**
 * Framework level reusable methods to perform operations on Excel - get rowcount, get celldata, Evaluating formula, set cell data, add/remove column, add/remove sheet, Convert CSV to Excel 
 * @author CignitiTeam
 *
 */
public class Xls_Reader {

	public String filename = System.getProperty("user.dir") + File.separator + "resources" + File.separator + "common" + File.separator + "testdata" + File.separator + "TestData.xlsx";
	public String path;
	...
	public String evaluateFormula(String sheetName, int colNum, int rowNum) {
		...
		try {
			...
			FileInputStream inputStream = new FileInputStream(new File(System.getProperty("user.dir") + File.separator + "resources" + File.separator + "common" + File.separator + "testData" + File.separator + "TestData.xlsx"));
